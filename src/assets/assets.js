...
export const partners=[partner3,partner1,partner2,partner4,partner5,partner6,partner7,partner8]
export const images = {hero,address,Logo,Logo2}
export const Icons = {tractor,lightning,agriculture,harvest,one,three,two,four,five}
